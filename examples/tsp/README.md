...
[Constraints](../../docs/book/src/modelling/constraints.md#why-the-reported-energy-is-not-just--total_value).
...
[Constraints](../../docs/book/src/modelling/constraints.md#choosing-a-penalty-weight)
...
[Three Programs](../../docs/book/src/concepts/three-programs.md) for why the
split exists.
